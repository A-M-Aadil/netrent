...
const CommercialPropertyCard = ({ data }: CommercialPropertyCardProps) => {
    return (
        <div className='w-full max-w-[406px] h-[340px] sm:h-[300px] p-2 flex flex-col gap-2 bg-white border-black/20 rounded-[20px] border-[1px]'>
            <div className='w-full h-[180px] flex items-center justify-center rounded-[12px] overflow-hidden'>
                <img src={data.img} alt='Property' className='object-cover object-center w-full h-full' />
            </div>
            <div className='w-full flex flex-col p-2 h-[calc(100%-180px)]'>
                <div className='w-full flex flex-col sm:flex-row gap-2 justify-between'>
                    <div className='w-full sm:w-2/3 flex flex-col'>
                        <h2 className='text-[#2D2D2D] text-[min(3vw,16px)] font-bold'>
                    ...
                    <div className='w-full sm:w-1/3 flex flex-col sm:items-end leading-6'>
                        ...
                        <p className='text-[min(3vw,12px)] text-[#2d2d2d]'>
                            GSM+ Outgoings
                        </p>
                    </div>
                </div>
